...
MAIN_ENTITY_WEB_URL     = 'http://www.castello.es/'

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_LEGAL_URL   = ''

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_PRIVACY_URL = 'http://www.castello.es/web30/pages/generico_web10.php?cod1=437&cod2=583'
